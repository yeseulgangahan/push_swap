...
/*   Updated: 2022/07/06 12:39:47 by yehan            ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void	quick_sort_stack_b(t_pushswap *pushswap, size_t left, size_t right)
{
	size_t	pivot1;
	size_t	pivot2;
	size_t	len;
	...
	else
	{
		...
		quick_sort_stack_a(pushswap, pivot2, right);
		move_range_to_top(pushswap, pivot2 - pivot1, rb_cnt);
		quick_sort_stack_a(pushswap, pivot1, pivot2 - 1);
		quick_sort_stack_b(pushswap, left, pivot1 - 1);
	}
}
